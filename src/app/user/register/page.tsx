  ...
  return (
    <section className="flex flex-row justify-center items-center gap-6 ">
      ...
      >
        ...
        <Typography placeholder={'what'} color="gray" className="mt-1 text-[2rem] text-center">
          Nice to meet you! Enter your details to register.
        </Typography>
        <Formik onSubmit={handleSubmit}
            className="mt-8 mb-2 w-80 max-w-screen-lg mx-auto sm:w-96" initialValues={initialValues} validationSchema={userSchema}>
          {/* <form
            
          > */}
            <div className="mb-1 flex flex-col gap-6">
              <Typography  placeholder={'what'}  variant="h6" color="blue-gray" className="-mb-3">
                FirstName
              </Typography>
              <Input
              crossOrigin={true}
